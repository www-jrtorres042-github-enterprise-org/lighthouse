...
function createTopbarComponent(dom) {
  ...
  el27.append(' ', ' ');
  const el28 = dom.createElement('button', 'lh-tools__button');
  el28.setAttribute('id', 'lh-tools-button');
  el28.setAttribute('title', 'Tools menu');
  el28.setAttribute('aria-label', 'Toggle report tools menu');
  el28.setAttribute('aria-haspopup', 'menu');
  el28.setAttribute('aria-expanded', 'false');
  el28.setAttribute('aria-controls', 'lh-tools-dropdown');
  const el29 = dom.createElementNS('http://www.w3.org/2000/svg', 'svg');
  el29.setAttribute('width', '100%');
  el29.setAttribute('height', '100%');
  el29.setAttribute('viewBox', '0 0 24 24');
  const el30 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  el30.setAttribute('d', 'M0 0h24v24H0z');
  el30.setAttribute('fill', 'none');
  const el31 = dom.createElementNS('http://www.w3.org/2000/svg', 'path');
  el31.setAttribute('d', 'M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z');
  el29.append(' ', el30, ' ', el31, ' ');
  el28.append(' ', el29, ' ');
  const el32 = dom.createElement('div', 'lh-tools__dropdown');
  el32.setAttribute('id', 'lh-tools-dropdown');
  el32.setAttribute('role', 'menu');
  el32.setAttribute('aria-labelledby', 'lh-tools-button');
  ...
  el33.setAttribute('data-i18n', 'dropdownPrintSummary');
  el33.setAttribute('data-action', 'print-summary');
  const el34 = dom.createElement('a', 'lh-report-icon lh-report-icon--print');
  el34.setAttribute('role', 'menuitem');
  el34.setAttribute('tabindex', '-1');
  el34.setAttribute('href', '#');
  el34.setAttribute('data-i18n', 'dropdownPrintExpanded');
  el34.setAttribute('data-action', 'print-expanded');
  const el35 = dom.createElement('a', 'lh-report-icon lh-report-icon--copy');
  el35.setAttribute('role', 'menuitem');
  el35.setAttribute('tabindex', '-1');
  el35.setAttribute('href', '#');
  el35.setAttribute('data-i18n', 'dropdownCopyJSON');
  el35.setAttribute('data-action', 'copy');
  ...
  el36.setAttribute('data-i18n', 'dropdownSaveHTML');
  el36.setAttribute('data-action', 'save-html');
  const el37 = dom.createElement('a', 'lh-report-icon lh-report-icon--download');
  el37.setAttribute('role', 'menuitem');
  el37.setAttribute('tabindex', '-1');
  el37.setAttribute('href', '#');
  el37.setAttribute('data-i18n', 'dropdownSaveJSON');
  el37.setAttribute('data-action', 'save-json');
  ...
  el38.setAttribute('data-i18n', 'dropdownViewer');
  el38.setAttribute('data-action', 'open-viewer');
  const el39 = dom.createElement('a', 'lh-report-icon lh-report-icon--open');
  el39.setAttribute('role', 'menuitem');
  el39.setAttribute('tabindex', '-1');
  el39.setAttribute('href', '#');
  el39.setAttribute('data-i18n', 'dropdownSaveGist');
  el39.setAttribute('data-action', 'save-gist');
  const el40 = dom.createElement('a', 'lh-report-icon lh-report-icon--dark');
  el40.setAttribute('role', 'menuitem');
  el40.setAttribute('tabindex', '-1');
  el40.setAttribute('href', '#');
  el40.setAttribute('data-i18n', 'dropdownDarkTheme');
  el40.setAttribute('data-action', 'toggle-dark');
  el32.append(' ', el33, ' ', el34, ' ', el35, ' ', el36, ' ', el37, ' ', el38, ' ', el39, ' ', el40, ' ');
  el26.append(' ', el27, ' ', el28, ' ', el32, ' ');
