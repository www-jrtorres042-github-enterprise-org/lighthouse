...
function createFooterComponent(dom) {
  ...
  const el5 = dom.createElement("ul", "lh-meta__items");
  el5.append(" ");
  const el6 = dom.createElement("ul", "lh-env__items");
  el6.append(" "," ");
  el3.append(" ",el4," ",el5," ",el6," ");
  const el7 = dom.createElement("div", "lh-generated");
  const el8 = dom.createElement("b");
  el8.append("Lighthouse");
  const el9 = dom.createElement("span", "lh-footer__version");
  const el10 = dom.createElement("a", "lh-footer__version_issue");
  el10.setAttribute('href', 'https://github.com/GoogleChrome/Lighthouse/issues');
  el10.setAttribute('target', '_blank');
  el10.setAttribute('rel', 'noopener');
  el10.append("File an issue");
  el7.append(" "," Generated by ",el8," ",el9," | ",el10," ");
  el2.append(" "," ",el3," ",el7," ");
  el0.append(el2);
  return el0;
}
